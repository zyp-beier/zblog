  ...
  <div class="welcome-page">
    <div :class="{ sticky: scorllTop > 300 }" class="default">
      <div  class="nav-list" >
        ...
        <div class="nav-item" @click="navClick('skill')"><a href="javascript:void(0)">技能<span class="border"></span></a></div>
        <div class="nav-item" @click="navClick('blog')"><a href="javascript:void(0)">博客<span class="border"></span></a></div>
      </div>
    </div>
  </div>
</template>
